...
public class InsertarConductorActivity extends  Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insertar_conductor);
    ...
    public void Registrar_Conductor(View view) {
        ...
        helper.abrir();
        regInsertados=helper.insertar(conductor);
        helper.cerrar();
